...
import com.zcst.manage.mapper.DuxueStudentMapper;
...
/**
 * 笃学馆学生管理 Service 业务层处理
 *
 * @author zcst
 * @date 2026-03-20
 */
@Service
public class DuxueStudentServiceImpl implements IDuxueStudentService
{
    @Autowired
    private DuxueStudentMapper studentMapper;
     ...
     * 批量删除笃学馆学生管理
     *
     * @param studentIds 需要删除的笃学馆学生管理主键
     * @return 结果
     */
    @Override
